...
---@field custominput_events table<defines.events, string>? Map of all known custom input events
...
function FrameworkGui.create(map)
    local gui = {
        ...
        type = map.type,
        prefix = map.prefix,
        gui_events = assert(map.gui_events),
        custominput_events = assert(map.custominput_events),
